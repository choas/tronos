...
describe("rm builtin command", () => {
  ...
  describe("basic file removal", () => {
    ...
    it("should remove multiple files", async () => {
      ...
      const result = await rm(["/file1.txt", "/file2.txt"], {
        stdin: "",
        env: {},
        vfs,
      });
    ...
    it("should fail for non-existent file without -f", async () => {
      const result = await rm(["/nonexistent.txt"], {
        stdin: "",
        env: {},
        vfs,
      });
  ...
  describe("combined flags", () => {
    ...
    it("should support -fr combined flag", async () => {
      const result = await rm(["-fr", "/nonexistent"], {
        stdin: "",
        env: {},
        vfs,
      });
...
describe("cp builtin command", () => {
  ...
  describe("basic file copying", () => {
    it("should copy a single file", async () => {
      ...
      const result = await cp(["/source.txt", "/dest.txt"], {
        stdin: "",
        env: {},
        vfs,
      });
    ...
    it("should fail when copying to existing directory (VFS limitation)", async () => {
      ...
      const result = await cp(["/source.txt", "/destdir"], {
        stdin: "",
        env: {},
        vfs,
      });
    ...
    it("should copy file to specific path inside directory", async () => {
      ...
      const result = await cp(["/source.txt", "/destdir/copied.txt"], {
        stdin: "",
        env: {},
        vfs,
      });
  ...
  describe("error handling", () => {
    ...
    it("should return error for non-existent source", async () => {
      const result = await cp(["/nonexistent.txt", "/dest.txt"], {
        stdin: "",
        env: {},
        vfs,
      });
    ...
    it("should return error for invalid option", async () => {
      const result = await cp(["-x", "/src", "/dest"], {
        stdin: "",
        env: {},
        vfs,
      });
...
describe("mv builtin command", () => {
  ...
  describe("basic file moving", () => {
    it("should move a file to new name (rename)", async () => {
      ...
      const result = await mv(["/oldname.txt", "/newname.txt"], {
        stdin: "",
        env: {},
        vfs,
      });
    ...
    it("should fail when moving to existing directory (VFS limitation)", async () => {
      ...
      const result = await mv(["/file.txt", "/destdir"], {
        stdin: "",
        env: {},
        vfs,
      });
    ...
    it("should move file to specific path inside directory", async () => {
      ...
      const result = await mv(["/file.txt", "/destdir/moved.txt"], {
        stdin: "",
        env: {},
        vfs,
      });
  ...
  describe("directory moving", () => {
    it("should move a directory", async () => {
      ...
      const result = await mv(["/srcdir", "/destdir"], {
        stdin: "",
        env: {},
        vfs,
      });
  ...
  describe("error handling", () => {
    ...
    it("should return error for non-existent source", async () => {
      const result = await mv(["/nonexistent.txt", "/dest.txt"], {
        stdin: "",
        env: {},
        vfs,
      });
...
describe("wc builtin command", () => {
  ...
  describe("flag options", () => {
    ...
    it("should support combined flags -lw", async () => {
      ...
      const result = await wc(["-lw", "/test.txt"], {
        stdin: "",
        env: {},
        vfs,
      });
  ...
  describe("multiple files", () => {
    it("should count multiple files and show total", async () => {
      ...
      const result = await wc(["/file1.txt", "/file2.txt"], {
        stdin: "",
        env: {},
        vfs,
      });
  ...
  describe("error handling", () => {
    it("should return error for non-existent file", async () => {
      const result = await wc(["/nonexistent.txt"], {
        stdin: "",
        env: {},
        vfs,
      });
...
describe("clear builtin command", () => {
  ...
  it("should ignore arguments", async () => {
    ...
    const result = await clear(["extra", "args"], {
      stdin: "",
      env: {},
      terminal,
    });
...
describe("history builtin command", () => {
  ...
  it("should return error for invalid count argument", async () => {
    ...
    const result = await history(["abc"], {
      stdin: "",
      env: {},
      history: historyList,
    } as any);
  ...
  it("should handle count larger than history length", async () => {
    ...
    const result = await history(["100"], {
      stdin: "",
      env: {},
      history: historyList,
    } as any);
...
describe("config builtin command", () => {
  ...
  describe("set subcommand", () => {
    it("should set provider and apply defaults", async () => {
      const result = await config(["set", "provider", "openai"], {
        stdin: "",
        env: {},
      });
    ...
    it("should set model", async () => {
      const result = await config(["set", "model", "gpt-4"], {
        stdin: "",
        env: {},
      });
    ...
    it("should set API key with masking", async () => {
      const result = await config(["set", "apiKey", "sk-test-1234567890"], {
        stdin: "",
        env: {},
      });
    ...
    it("should set temperature", async () => {
      const result = await config(["set", "temperature", "0.5"], {
        stdin: "",
        env: {},
      });
    ...
    it("should set maxTokens", async () => {
      const result = await config(["set", "maxTokens", "2000"], {
        stdin: "",
        env: {},
      });
    ...
    it("should reject invalid provider", async () => {
      const result = await config(["set", "provider", "invalid"], {
        stdin: "",
        env: {},
      });
    ...
    it("should reject invalid key", async () => {
      const result = await config(["set", "invalidKey", "value"], {
        stdin: "",
        env: {},
      });
    ...
    it("should reject temperature out of range", async () => {
      const result = await config(["set", "temperature", "3.0"], {
        stdin: "",
        env: {},
      });
    ...
    it("should reject invalid maxTokens", async () => {
      const result = await config(["set", "maxTokens", "-100"], {
        stdin: "",
        env: {},
      });
