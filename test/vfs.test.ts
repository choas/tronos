...
describe("VFS File CRUD Operations", () => {
  ...
  describe("write()", () => {
    ...
    it("should throw error when parent directory does not exist", () => {
      expect(() => vfs.write("/nonexistent/file.txt", "content")).toThrow(
    ...
    it("should throw error when writing to a directory", () => {
      vfs.mkdir("/testdir");
      expect(() => vfs.write("/testdir", "content")).toThrow("not a file");
    });
  ...
  describe("read()", () => {
    ...
    it("should throw error for non-existent file", () => {
      expect(() => vfs.read("/nonexistent.txt")).toThrow(
        "no such file or directory",
      );
    });
    ...
    it("should throw error when reading a directory", () => {
      vfs.mkdir("/testdir");
      expect(() => vfs.read("/testdir")).toThrow("not a file");
    });
  ...
  describe("append()", () => {
    ...
    it("should throw error when appending to a directory", () => {
      vfs.mkdir("/testdir");
      expect(() => vfs.append("/testdir", "content")).toThrow("not a file");
    });
  });
  ...
  describe("remove() for files", () => {
    ...
    it("should throw error for non-existent file", () => {
      expect(() => vfs.remove("/nonexistent.txt")).toThrow(
        "no such file or directory",
      );
    });
  ...
  describe("stat()", () => {
    ...
    it("should throw error for non-existent path", () => {
      expect(() => vfs.stat("/nonexistent")).toThrow(
        "no such file or directory",
      );
    });
  ...
  describe("copy()", () => {
    ...
    it("should throw error when source does not exist", () => {
      expect(() => vfs.copy("/nonexistent.txt", "/dest.txt")).toThrow(
        "no such file or directory",
      );
    });
    ...
    it("should throw error when destination already exists", () => {
      ...
      expect(() => vfs.copy("/original.txt", "/existing.txt")).toThrow(
    ...
    it("should require recursive flag for directories", () => {
      vfs.mkdir("/srcdir");
      expect(() => vfs.copy("/srcdir", "/destdir")).toThrow(
  ...
  describe("move()", () => {
    ...
    it("should throw error when source does not exist", () => {
      expect(() => vfs.move("/nonexistent.txt", "/dest.txt")).toThrow(
        "no such file or directory",
      );
    });
    ...
    it("should throw error when destination already exists", () => {
      vfs.write("/original.txt", "content");
      vfs.write("/existing.txt", "other");
      expect(() => vfs.move("/original.txt", "/existing.txt")).toThrow(
        "destination already exists",
      );
    });
    ...
    it("should throw error when destination directory does not exist", () => {
      vfs.write("/original.txt", "content");
      expect(() => vfs.move("/original.txt", "/nonexistent/dest.txt")).toThrow(
        "no such directory",
      );
    });
  });
...
describe("VFS Directory Operations", () => {
  ...
  describe("mkdir()", () => {
    ...
    it("should throw error when directory already exists", () => {
      vfs.mkdir("/newdir");
      expect(() => vfs.mkdir("/newdir")).toThrow("file exists");
    });

    it("should throw error when parent does not exist (non-recursive)", () => {
      expect(() => vfs.mkdir("/nonexistent/child")).toThrow(
        "no such file or directory",
      );
    });
    ...
    it("should throw error when parent is a file", () => {
      ...
      expect(() => vfs.mkdir("/file.txt/subdir")).toThrow("not a directory");
    });
  ...
  describe("list()", () => {
    ...
    it("should throw error for non-existent directory", () => {
      expect(() => vfs.list("/nonexistent")).toThrow("no such directory");
    });

    it("should throw error when listing a file", () => {
      vfs.write("/test.txt", "content");
      expect(() => vfs.list("/test.txt")).toThrow("no such directory");
    });
  ...
  describe("listDetailed()", () => {
    ...
    it("should throw error for non-existent directory", () => {
      expect(() => vfs.listDetailed("/nonexistent")).toThrow(
        "no such directory",
      );
    });
    ...
    it("should throw error when listing a file", () => {
      vfs.write("/test.txt", "content");
      expect(() => vfs.listDetailed("/test.txt")).toThrow("no such directory");
    });
  });
  ...
  describe("remove() for directories", () => {
    ...
    it("should throw error for non-empty directory without recursive", () => {
      ...
      expect(() => vfs.remove("/nonempty")).toThrow("directory not empty");
    });
...
describe("VFS Path Resolution", () => {
  ...
  describe("chdir()", () => {
    ...
    it("should throw error for non-existent directory", () => {
      expect(() => vfs.chdir("/nonexistent")).toThrow(
        "no such file or directory",
      );
    });
    ...
    it("should throw error when changing to a file", () => {
      vfs.write("/test.txt", "content");
      expect(() => vfs.chdir("/test.txt")).toThrow("not a directory");
    });
  ...
  describe("resolve()", () => {
    ...
    it("should resolve complex paths", () => {
      vfs.chdir("/home/tronos");
      expect(vfs.resolve("./docs/../projects/./app")).toBe(
        "/home/tronos/projects/app",
      );
    });
  });
