...
describe("curl builtin", () => {
  ...
  describe("HTTP methods", () => {
    ...
    it("should respect explicit method with data", async () => {
      ...
      await curl(
        ["-X", "PUT", "-d", "key=value", "https://example.com"],
        context,
      );
  ...
  describe("headers", () => {
    it("should pass custom header with -H", async () => {
      ...
      await curl(
        ["-H", "Authorization: Bearer token123", "https://example.com"],
        context,
      );
  ...
  describe("data", () => {
    it("should send data with -d", async () => {
      ...
      await curl(
        ["-d", "key=value&other=data", "https://example.com"],
        context,
      );
  ...
  describe("output", () => {
    ...
    it("should write to file with -o", async () => {
      ...
      const result = await curl(
        ["-o", "output.txt", "https://example.com"],
        context,
      );
    ...
    it("should write to absolute path with -o", async () => {
      ...
      const result = await curl(
        ["-o", "/tmp/output.txt", "https://example.com"],
        context,
      );
  ...
  describe("error handling", () => {
    ...
    it("should handle CORS errors", async () => {
      global.fetch = vi
        ...
        .mockRejectedValue(
          new Error(
            "CORS error: The server at https://example.com doesn't allow requests",
          ),
        );
...
describe("fetch builtin", () => {
  ...
  it("should return response body on success", async () => {
    global.fetch = vi
      .fn()
      .mockResolvedValue(new Response("Response body", { status: 200 }));
