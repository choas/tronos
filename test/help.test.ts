...
describe("help builtin command", () => {
  ...
  it("should display help for which command", async () => {
    ...
    expect(result.stdout).toContain(
      "which: Show the full path or type of a command",
    );
  ...
  it("should return error for unknown command", async () => {
    ...
    expect(result.stderr).toBe(
      "help: no help topics match `unknowncommand'. Try 'help' for a list of commands.",
    );
  ...
  it("should display info for executable files in /bin", async () => {
    ...
    expect(result.stdout).toContain(
      "myprogram: executable file at /bin/myprogram.trx",
    );
