...
describe("AIBridge", () => {
  ...
  describe("buildMessages", () => {
    it("should build messages for chat mode", () => {
      ...
      const result = bridge.buildMessages(
        "chat",
        "Hello, how are you?",
        mockContext,
      );
  ...
  describe("parseCode", () => {
    it("should extract code from javascript code blocks", () => {
      ...
      expect(bridge.parseCode(response)).toBe(
        "// @name: test\nasync function main(t) {}",
      );
    });
...
<code>// fixed code</code>`;
      ...
      expect(bridge.parseFixExplanation(response)).toBe(
        "The syntax error was caused by a missing parenthesis.",
      );
    });
    ...
    describe("chat mode", () => {
      it("should return content as message", () => {
        ...
        expect(result.message).toBe(
          "TronOS is an AI-powered operating system in your browser.",
        );
      });
    ...
    describe("explain mode", () => {
      it("should return content as message", () => {
        ...
        const response: AIResponse = {
          success: true,
          content:
            "This function counts down from 10 to 0 with a 1-second delay.",
        };
    ...
    describe("fix mode", () => {
      it("should extract both code and explanation", () => {
        ...
        const response: AIResponse = {
          success: true,
          content:
            "<explanation>The syntax error was caused by a missing parenthesis.</explanation>\n<code>// @name: fixed\nasync function main(t) {}</code>",
        };
