...
const style = {
  ...
  strikethrough: (str: string) =>
    `${styles.strikethrough}${str}${styles.reset}`,
  ...
  brightMagenta: (str: string) =>
    `${styles.brightMagenta}${str}${styles.reset}`,
