...
const MAN_PAGES: Record<string, ManPage> = {
  ...
  touch: {
    ...
    sections: [
      {
        name: "NAME",
        content: ["touch - change file timestamps or create empty files"],
      },
  ...
  cp: {
    ...
    sections: [
      ...
      { name: "OPTIONS", content: ["-r    Copy directories recursively"] },
      {
        name: "EXAMPLES",
        content: [
  ...
  grep: {
    ...
    sections: [
      ...
      {
        name: "SYNOPSIS",
        content: ["grep [-i] [-v] [-n] [-c] pattern [file...]"],
      },
      {
        name: "DESCRIPTION",
        content: [
  ...
  unalias: {
    ...
    sections: [
      ...
      { name: "OPTIONS", content: ["-a    Remove all alias definitions"] },
      {
        name: "EXAMPLES",
        content: [
  ...
  type: {
    ...
    sections: [
      {
        name: "NAME",
        content: ["type - display information about command type"],
      },
  ...
  source: {
    ...
    sections: [
      {
        name: "NAME",
        content: ["source - execute commands from a file in the current shell"],
      },
  ...
  session: {
    ...
    sections: [
      ...
      {
        name: "SYNOPSIS",
        content: ["session [list|switch|new|delete] [name]"],
      },
      {
        name: "DESCRIPTION",
        content: [
  ...
  fetch: {
    ...
    sections: [
      ...
      {
        name: "EXAMPLES",
        content: ["fetch https://api.example.com/data    Fetch JSON data"],
      },
  ...
  "factory-reset": {
    ...
    sections: [
      {
        name: "NAME",
        content: ["factory-reset - restore TronOS to initial state"],
      },
...
function formatManPage(page: ManPage): string {
  ...
  output.push(
    `${bold(page.name.toUpperCase())}(${page.section})${" ".repeat(20)}User Commands${" ".repeat(20)}${bold(page.name.toUpperCase())}(${page.section})`,
  );
  output.push("");
